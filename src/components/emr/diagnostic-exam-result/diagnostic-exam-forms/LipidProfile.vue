        ...
        <template>
            <v-row class="pa-4">
                <v-col sm="12" md="12" lg="12">
                    ...
                    <div class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Ldl </span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pLdl" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Hdl </span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pHdl" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Total</span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pTotal" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Cholesterol </span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pCholesterol" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Triglycerides </span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pTriglycerides" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div class="form-div">
