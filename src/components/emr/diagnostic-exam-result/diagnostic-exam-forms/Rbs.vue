            ...
            <v-row class="pa-4">
                <v-col sm="12" md="12" lg="12">
                    <div class="form-div">
                        ...
                        <v-textarea v-model="diagnostic_exam.diagnostic.pReferralFacility" rows="1" auto-grow variant="outlined" placeholder="If referred to other facility" hide-details dense :readonly="emr_page"> </v-textarea>
                    </div>
                    <div class="form-div">
                    ...
                    <div  v-if="conversion_unit === 'CU'"  class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> (mg/dL) </span>
                    ...
                    <div  v-else class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> (mmol/L) </span>
