                ...
                <v-col sm="12" md="12" lg="12">
                    ...
                    <div class="form-div">
                        ...
                        <template v-if="emr_page">
                            <v-combobox v-model="diagnostic_exam.diagnostic.pFindings" :items="findings_list_items[0]" item-text="LibDesc" item-value="LibID" :readonly="emr_page" dense return-object>
                            </v-combobox>
                        </template>
                        <template v-else>
                            <v-combobox v-model="diagnostic_exam.diagnostic.pFinds" :items="findings_list_items[0]" item-text="LibDesc" item-value="LibID" :readonly="emr_page" dense return-object>
                            </v-combobox>
                        </template>
                    </div>
                    <div class="form-div">
