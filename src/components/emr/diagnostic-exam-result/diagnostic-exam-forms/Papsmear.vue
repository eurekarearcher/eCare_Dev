        ...
        <template>
            <v-row class="pa-4">
                <v-col sm="12" md="12" lg="12">
                    ...
                    <div class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Impression </span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pImpression" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div class="form-div">
