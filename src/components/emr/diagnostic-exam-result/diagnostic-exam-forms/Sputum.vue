                ...
                <v-col sm="12" md="12" lg="12">
                    ...
                    <div class="form-div">
                        ...
                        <!-- <v-menu :close-on-content-click="false" transition="scale-transition" min-width="auto" offset-y top>
                            ...
                            <v-date-picker v-model="diagnostic_exam.diagnostic.pLabDate" no-title></v-date-picker>
                        </v-menu> -->
                        <v-menu :close-on-content-click="false" transition="scale-transition" min-width="auto" offset-y top>
                            <template v-slot:activator="{ on }">
                    ...
                    <div class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Data Collection </span>
                        <template v-if="emr_page">
                            <v-select v-model="diagnostic_exam.diagnostic.pDataCollection" :items="observation_list_items[0]" item-text="LibDesc" item-value="LibID" :readonly="emr_page" dense return-object>
                            </v-select>
                        </template>
                        <template v-else>
                            <v-select v-model="diagnostic_exam.diagnostic.pDC" :items="observation_list_items[0]" item-text="LibDesc" item-value="LibID" :readonly="emr_page" dense return-object>
                            </v-select>
                        </template>
                    </div>
                    <div class="form-div">
                    ...
                    <div class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> No Plusses </span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pNoPlusses" maxlength="5" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div class="form-div">
