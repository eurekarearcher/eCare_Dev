<template>
    <v-card>
        ...
        <div class="d-none"> {{ diagnostic_exam }}</div>
        <template>
            <v-row class="pa-4">
                <v-col sm="12" md="12" lg="12">
                    ...
                    <div class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Other Diagnostic Exam </span>
                        <v-text-field v-model="diagnostic_exam.cpt_desc" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Findings </span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pFindings" hide-details dense :readonly="emr_page"></v-text-field>
                    </div>
                    <div class="form-div">
