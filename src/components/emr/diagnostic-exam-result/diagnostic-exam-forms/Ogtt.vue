            ...
            <v-row class="pa-4">
                <v-col sm="12" md="12" lg="12">
                    ...
                    <div v-if="conversion_unit === 'CU'"  class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> ExamFasting (mg/Dl) </span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pExamFastingMg" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div v-else class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> ExamFasting (mmol/L)</span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pExamFastingMmol" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div v-if="conversion_unit === 'CU'"  class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Exam Ogtt One Hr (mg/dL) </span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pExamOgttOneHrMg" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div v-else class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Exam Ogtt One Hr (mmol/L) </span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pExamOgttOneHrMmol" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div v-if="conversion_unit === 'CU'"  class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Exam Ogtt Two Hr (mg/dL)</span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pExamOgttTwoHrMg" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div v-else class="form-div">
                        <span class="pr-2 body-2 font-weight-medium label-width"> Exam Ogtt Two Hr (mmol/L) </span>
                        <v-text-field v-model="diagnostic_exam.diagnostic.pExamOgttTwoHrMmol" hide-details dense :readonly="emr_page"> </v-text-field>
                    </div>
                    <div class="form-div">
